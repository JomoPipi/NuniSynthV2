...
export function recordTo(index) {
    ...
    if (D('record-mic').checked) {
        ...
        handleStream(mediaStreamDestination.stream, () => audioCtx.volume.disconnect(mediaStreamDestination));
    }
    function handleStream(stream, f) {
        ...
        mediaRecorder.addEventListener('stop', () => {
            ...
            audioBlob.arrayBuffer().then(arraybuffer => {
                audioCtx.decodeAudioData(arraybuffer)
                    ...
                    const buffer = audioCtx.createBuffer(1, BufferUtils.nextBufferDuration * rate, rate);
        ...
        BufferUtils.lastRecorderRequestId =
            setTimeout(BufferUtils.stopLastRecorder, BufferUtils.nextBufferDuration * 1000);
    }
}
