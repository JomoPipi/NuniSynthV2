...
const tempoComponent = createNumberDialComponent(120, (value) => _tempo = clamp(1, value, 69420), { dial: { sensitivity: 2 ** -2,
        min: 20,
        max: 999,
        rounds: 8
    }
